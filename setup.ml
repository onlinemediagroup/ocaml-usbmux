...
(* OASIS_START *)
(* DO NOT EDIT (digest: 5d9cb1c109d92c6c399a1ab0909de099) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/onlinemediagroup/ocaml-usbmux";
          synopsis = "Control port remapping for iOS devices";
          description =
            Some [OASISText.Para "Talk to jailbroken iDevices over USB."];
          categories = [];
          ...
          build_custom =
            {
               pre_command = [(OASISExpr.EBool true, None)];
               post_command =
                 [(OASISExpr.EBool true, Some (("sh", ["install_man.sh"])))]
            };
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/onlinemediagroup/ocaml-usbmux.git";
                      src_repo_browser =
                        Some
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\b)\230\160\198\011\0013\250\173\224\023\214M\209i";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
