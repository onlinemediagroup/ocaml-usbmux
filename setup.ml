...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6ddfcd72aa4f2bc2a17183d9517af266) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/fxfactorial/ocaml-usbmuxd";
          synopsis = "ocaml program";
          description = Some [OASISText.Para "Talk to iDevices"];
          categories = [];
                 ...
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("cp",
                           [
                              "src/lib/usbmuxd_stubs.m";
                              "src/lib/usbmuxd_stubs.c"
                           ])))
                 ];
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("rm", ["src/lib/usbmuxd_stubs.c"])))
                 ]
            };
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage ("plist", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["usbmuxd_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-ObjC"; "-fobjc-arc"])];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Z§ø\022¬\016s4\134\1348\023\002ìE\158";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
